...
Write reports that triagers can reproduce quickly. Never use "could potentially."
...
Works on HackerOne, Bugcrowd, Immunefi, and Intigriti. Adjust field names per platform and include only evidence you can reproduce.
...
See verdict for full CVSS quick reference table and metric guide.
...
- One bug per report unless the chain is required to prove impact
- If duplicate, respond professionally with only genuinely new evidence
