...
Default: fail closed. One wrong answer stops the report path until the missing proof is collected or the finding is killed.
...
Store evidence in the disposable workspace or report artifact, not in this docs repo.
...
1. Can't fill exploit template quickly → move on
...
6. Long PoC work with no reproduction → summarize the dead end and rotate
