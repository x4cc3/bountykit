#!/usr/bin/env python3
"""
map.py — Generates a Mermaid mind map + prioritized hunting checklist
based on target type and detected technologies.

Usage:
  python3 core/map.py --target target.com --type opensrc --tech "nextjs,graphql,solidity"
  python3 core/map.py --target example.com --type website --tech "nginx,react"
  python3 core/map.py --target api.example.com --type api --tech "jwt,openapi"
"""
