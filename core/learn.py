...
Usage:
  python3 core/learn.py --tech "nextjs,graphql"
  python3 core/learn.py --tech "nextjs,graphql" --target target.com --output recon/target.com/intel.md
  python3 core/learn.py --tech "solidity" --hackerone-program target-program
"""
