#!/usr/bin/env python3
"""
Edge-Case Bug Finder
Automated fuzzing and edge-case testing for logic flaws.
...
Usage:
    python3 core/fuzz.py <target_url>
    python3 core/fuzz.py --recon-dir <recon_dir>
    python3 core/fuzz.py <target_url> --deep
"""
...
class ZeroDayFuzzer:
    def __init__(self, target, findings_dir=None, deep=False):
        ...
        if findings_dir:
            ...
            self.findings_dir = os.path.join(FINDINGS_DIR, self.domain, "edge_cases")
    ...
    def run_all_tests(self):
        """Run all edge-case detection tests."""
        print(f"\n{'=' * 55}")
    ...
    def save_findings(self):
        ...
        output_file = os.path.join(self.findings_dir, "edge_case_findings.json")
        ...
        text_file = os.path.join(self.findings_dir, "edge_case_findings.txt")
