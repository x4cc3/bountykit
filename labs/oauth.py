...
Usage:
  python3 labs/oauth.py --email your@email.com
  python3 labs/oauth.py --check-cors
  python3 labs/oauth.py --check-reset --email your@email.com
  python3 labs/oauth.py --token-a YOUR_TOKEN

If omitted, Account A tokens are read from H1_TOKEN_A or prompted on a TTY.
"""
