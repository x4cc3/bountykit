---
description: Smart contract security audit — runs 10 bug class checklist from contract-review track with Foundry PoC. Usage: /contract-sweep <contract.sol>
---
...
1. Run pre-dive kill signals from `tracks/contract-review/SKILL.md` — skip if score < 6/10
...
ALL bug class details, grep patterns, variants, and PoC template live in `tracks/contract-review/SKILL.md`. This playbook is the execution wrapper only.
